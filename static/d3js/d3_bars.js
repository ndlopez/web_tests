...
barGroups.append('rect')
	...
	d3.select(this)
          ...
          .duration(300)
          .attr('opacity', 0.6)
          .attr('x', (a) => xScale(a.lang) - 0)
          .attr('width', xScale.bandwidth() + 0)

	//barGroups.attr("fill",(a)=>zScale(a.color))
        const y = yScale(actual.val);
        ...
        barGroups.append("text")
          ...
          .attr('x', (a) => xScale(a.lang) + xScale.bandwidth() / 2)
          .attr('y', (a) => yScale(a.val) + 30)
          .attr('fill', "white")
          .attr('text-anchor', "middle")
          .text((a, idx) => {
            const divergence = (a.val - actual.val).toFixed(1)
            let text = ''
